...
const STRINGS = {
  en: {
    ...
    renameList: "Rename list", deleteList: "Delete list", deleteListConfirm: 'Delete "{name}"? This cannot be undone.', backToLists: "Lists", untitledList: "My List",
  ...
  zh: {
    ...
    renameList: "重新命名清單", deleteList: "刪除清單", deleteListConfirm: '刪除「{name}」？此操作無法復原。', backToLists: "清單", untitledList: "我嘅清單",
  ...
  "zh-Hans": {
    ...
    renameList: "重命名清单", deleteList: "删除清单", deleteListConfirm: '删除「{name}」？此操作无法撤销。', backToLists: "清单", untitledList: "我的清单",
  ...
  fr: {
    ...
    renameList: "Renommer la liste", deleteList: "Supprimer la liste", deleteListConfirm: 'Supprimer « {name} » ? Action irréversible.', backToLists: "Listes", untitledList: "Ma liste",
  ...
  es: {
    ...
    renameList: "Renombrar lista", deleteList: "Eliminar lista", deleteListConfirm: '¿Eliminar "{name}"? No se puede deshacer.', backToLists: "Listas", untitledList: "Mi lista",
